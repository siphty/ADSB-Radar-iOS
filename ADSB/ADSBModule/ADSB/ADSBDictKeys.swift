...
struct ExRspKeys {
    ...
    static let HasPictures:     String = "showPic"  //Depreciated
...
struct AcKeys {
    ...
    static let IsFoundByMLAT:   String = "Mlat"     //True if the latitude and longitude appear to have been calculated by an MLAT server and were not transmitted by the aircraft.
    ...
    static let AcOperator:      String = "Op"       //The name of the aircraft's operator.
    static let AcOperatorICAO:  String = "OpCode"   //The operator's ICAO code.
    ...
    static let ViewerDistance:  String = "Dst"      //The distance to the aircraft in kilometres.
    static let ViewerBearing:   String = "Brng"     //The bearing from the browser to the aircraft clockwise from 0° north.
    ...
    static let IsSatComFeed:    String = "Sat"      //True if the aircraft has been seen on a SatCom ACARS feed (e.g. a JAERO feed).
    static let ShortTrails:     String = "Cos"      //Short trails
    static let FullTrails:      String = "Cot"      //Full trails
    static let HasResetTrail:   String = "ResetTrail"   //True if the entire trail has been sent
