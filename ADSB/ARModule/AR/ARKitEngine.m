    ...
    if ((self = [super init])) {
        ...
        switch (conf.orientation) {
            ...
            case UIInterfaceOrientationLandscapeLeft:{
                ...
                orientationSupporter.xOffset = -87.0;
...
- (void) doStart {
    ...
    arMonocularViewController * rootViewController = (arMonocularViewController*)(topWindow.rootViewController);
